...
class OAuthCCGManager extends CoreAuth implements OAuthCCGCredentials
{
    ...
    {
        return $this->config['OAuthCCG-ClockSkew'] ?? ConfigurationDefaults::O_AUTH_CCG_CLOCK_SKEW;
    }
    ...
    private function getTokenFromProvider(): ?OAuthToken
    {
        ...
        $provider = $this->config['OAuthCCG-TokenProvider'];
        ...
        $updateCallback = $this->config['OAuthCCG-OnTokenUpdate'];
