...
class OAuthCCGCredentialsBuilder
{
    ...
    {
        $this->config['OAuthCCG-ClockSkew'] = $oAuthClockSkew;
        return $this;
    }

    /**
     * Setter for the OAuthTokenProvider callable with 2 arguments. Arg1 will be the last OAuthToken
     * instance, while Arg2 will be an instance of OAuthCCGManager. The return type of callable should be
     * an instance of OAuthToken model.
     *
     * @param callable(OAuthToken, OAuthCCGManager): OAuthToken $oAuthTokenProvider
     *
     * @return $this
     */
    public function oAuthTokenProvider(callable $oAuthTokenProvider): self
    {
        $this->config['OAuthCCG-TokenProvider'] = $oAuthTokenProvider;
        return $this;
    }
    ...
    {
        $this->config['OAuthCCG-OnTokenUpdate'] = $oAuthOnTokenUpdate;
        return $this;
    }
