...
class OAuthACGManager extends CoreAuth implements OAuthACGCredentials
{
    ...
    {
        return $this->config['oAuthRedirectUri2'] ?? ConfigurationDefaults::O_AUTH_REDIRECT_URI_2;
    }
    ...
    {
        return $this->config['OAuthACG-ClockSkew'] ?? ConfigurationDefaults::O_AUTH_ACG_CLOCK_SKEW;
    }
